...
#define SERV_0_HEADER "ReceiverService.h"
// the name of the Init function
#define SERV_0_INIT InitReceiverService
// the name of the run function
#define SERV_0_RUN RunReceiverService
...
#define TIMER15_RESP_FUNC PostReceiverService

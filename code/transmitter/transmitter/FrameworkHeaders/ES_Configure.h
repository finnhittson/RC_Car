...
#define SERV_0_HEADER "TransmitService.h"
// the name of the Init function
#define SERV_0_INIT InitTransmitService
// the name of the run function
#define SERV_0_RUN RunTransmitService
...
#define TIMER15_RESP_FUNC PostTransmitService
